      ...
      <div className="max-w-6xl mx-auto relative md:h-[1350px]">
        ...
        <div data-aos="fade-up" className="md:absolute top-10 left-0 md:w-[450px] z-20 mb-16 md:mb-0">
          ...
          <p className="text-gray-500 text-base md:text-lg max-w-sm font-medium leading-relaxed">
            Combining full-stack development, DevOps, ERP systems, and cloud technologies to create scalable and impactful digital experiences.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-8 md:gap-12 items-center md:block relative z-10 w-full pt-4 md:pt-0 pb-12 md:pb-0">
          ...
          <TagCard
            ...
            text="Building secure REST APIs, FastAPI services, authentication systems, server-side applications, and database integrations with Node.js, Python, PostgreSQL, and scalable architectures."
          ...
          <TagCard
            number="03"
            title="DevOps & Cloud"
            text="Deploying and managing applications using Docker, GitHub Actions, CI/CD pipelines, cloud platforms, and performance optimization practices for reliable production systems."
          ...
          <TagCard
            number="04"
            title="ERP Systems"
            text="Implementing and customizing enterprise resource planning solutions, integrating business workflows, managing data pipelines, and delivering end-to-end ERP configurations for real-world operations."
